		              ...
		              <td>
		                <div class="d-flex px-2 py-1">
		                  <div class="d-flex flex-column justify-content-center">
		                    <h6 class="mb-0 text-sm">{{ $banner->name }}</h6>
		                  </div>
		                </div>
		              </td>
		              <td>
		                <p class="text-xs font-weight-bold mb-0"><img src="{{ asset('assets/'.$banner->img_src)}}" width="150px"></p>
		              </td>
		              <td class="align-middle">
		                <a class="btn btn-link text-danger text-gradient mb-0" href="{{ route('admin.destroybanner', encrypt($banner->id))}}"><i class="far fa-trash-alt me-2"></i>Delete</a>
...
<div id="myModal" class="modal fade" tabindex="-1">
  <div class="modal-dialog">
      <div class="modal-content">
          ...
          <form class="" id="myform" action="{{ route('admin.banneradd')}}" method="POST" enctype="multipart/form-data">
	        @csrf
