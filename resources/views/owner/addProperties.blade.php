...
@section('css')
<link rel="stylesheet" type="text/css" href="{{asset('assets/owner/css/multistep.css')}}">
<style type="text/css">
.room_type{
    padding: 10px;
    color: #fff;
  ...
  <div class="col-xl-7 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <!-- MultiStep Form -->
        <form action="{{ route('owner.propertysave')}}" method="post" id="multistep_form">
          @csrf
...
<script src="{{asset('assets/owner/js/multistep-form.js')}}"></script>
<script src="{{asset('assets/owner/js/multiselect.js')}}"></script>
<script>
