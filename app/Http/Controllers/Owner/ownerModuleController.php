...
class ownerModuleController extends Controller
{
    ...
    {
        return view('owner.addProperties');
    }
    ...
    public function allProperties()
    {
        ...
        return view('owner.allProperties', compact('data'));
    }
    ...
    public function settings()
    {
        ...
        return view('owner.settings',compact('data'));
    }
    ...
    public function editProperties($id)
    {
        ...
        return view('owner.editProperties', compact('data'));
    }
